...
var N = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
	...
	oi = (e, t, r, n) => {
		if ((t && typeof t == 'object') || typeof t == 'function')
			for (let i of wl(t))
				!bl.call(e, i) && i !== r && $t(e, i, { get: () => t[i], enumerable: !(n = hl(t, i)) || n.enumerable });
		return e;
	};
var q = (e, t, r) => (
		(r = e != null ? yl(xl(e)) : {}),
		oi(t || !e || !e.__esModule ? $t(r, 'default', { value: e, enumerable: !0 }) : r, e)
	),
...
var Ss = N(m => {
	...
	m.add4H = Ps;
	var As = (e, t, r, n, i) => (e >>> 0) + (t >>> 0) + (r >>> 0) + (n >>> 0) + (i >>> 0);
	m.add5L = As;
...
var Os = N(h => {
	...
	var Yu = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, '0'));
	function ep(e) {
		(0, Sn.abytes)(e);
		let t = '';
...
var $s = N(v => {
	...
	for (let e = 0, t = Tt, r = 1, n = 0; e < 24; e++) {
		(([r, n] = [n, (2 * r + 3 * n) % 5]), Ms.push(2 * (5 * n + r)), Ds.push((((e + 1) * (e + 2)) / 2) % 64));
		let i = up;
		for (let o = 0; o < 7; o++)
			((t = ((t << Tt) ^ ((t >> dp) * fp)) % mp), t & pp && (i ^= Tt << ((Tt << BigInt(o)) - Tt)));
		_s.push(i);
	}
	var [gp, yp] = (0, Pt.split)(_s, !0),
		Is = (e, t, r) => (r > 32 ? (0, Pt.rotlBH)(e, t, r) : (0, Pt.rotlSH)(e, t, r)),
		Fs = (e, t, r) => (r > 32 ? (0, Pt.rotlBL)(e, t, r) : (0, Pt.rotlSL)(e, t, r));
	function Ns(e, t = 24) {
	...
	var Ls = (e, t, r) =>
		(0, te.wrapXOFConstructorWithOpts)((n = {}) => new At(t, e, n.dkLen === void 0 ? r : n.dkLen, !0));
...
typeof process < 'u' &&
	(({ FORCE_COLOR: Br, NODE_DISABLE_COLORS: pi, NO_COLOR: di, TERM: mi } = process.env || {}),
	(fi = process.stdout && process.stdout.isTTY));
var gi = { enabled: !pi && di == null && mi !== 'dumb' && ((Br != null && Br !== '0') || fi) };
function T(e, t) {
	let r = new RegExp(`\\x1b\\[${t}m`, 'g'),
		n = `\x1B[${e}m`,
		i = `\x1B[${t}m`;
	return function (o) {
		return !gi.enabled || o == null ? o : n + (~('' + o).indexOf(i) ? o.replace(r, i + n) : o) + i;
	};
}
var Tl = T(0, 0),
	j = T(1, 22),
...
function Ul(e) {
	let t = { color: yi[ql++ % yi.length], enabled: nt.enabled(e), namespace: e, log: nt.log, extend: () => {} },
		r = (...n) => {
			let { enabled: i, namespace: o, color: s, log: a } = t;
			if ((n.length !== 0 && rt.push([o, ...n]), rt.length > Vl && rt.shift(), nt.enabled(o) || i)) {
				let l = n.map(u => (typeof u == 'string' ? u : jl(u))),
					c = `+${Date.now() - hi}ms`;
				((hi = Date.now()), globalThis.DEBUG_COLORS ? a(Vt[s](j(o)), ...l, Vt[s](c)) : a(o, ...l, c));
			}
		};
...
var it = { error: de('prisma:error'), warn: et('prisma:warn'), info: X('prisma:info'), query: me('prisma:query') },
...
var lt = {};
Ae(lt, { ModelAction: () => Re, datamodelEnumToSchemaEnum: () => Zl, datamodelSchemaEnumToSchemaEnum: () => Xl });
function Zl(e) {
...
var Yl = e => e,
	...
	f = {
		...
		util: {
			...
			objId: function (e) {
				return (e.__id || Object.defineProperty(e, '__id', { value: ++ec }), e.__id);
			},
					...
					for (let _ = n, ne = i; _ < t.length; ne += t[_].length, ++_) {
						...
						if (Pe && _ != t.length - 1) {
							...
							var u = p.index + (V ? p[1].length : 0),
								...
								a = _,
								l = ne;
							for (let gl = t.length; a < gl && (l < y || (!t[a].type && !t[a - 1].greedy)); ++a)
...
var nc = { red: de, gray: tt, dim: Ze, bold: j, underline: Xe, highlightSource: e => e.highlight() },
	ic = { red: e => e, gray: e => e, dim: e => e, bold: e => e, underline: e => e, highlightSource: e => e };
...
function sc({ callsite: e, message: t, originalMethod: r, isPanic: n, callArguments: i }, o) {
	...
	if (c && u) {
		...
		((s.functionName = `${y.code})`),
			(s.location = a),
			n || (c = c.mapLineAt(a.lineNumber, b => b.slice(0, y.openingBraceIndex))),
...
function cc({ functionName: e, location: t, message: r, isPanic: n, contextLines: i, callArguments: o }, s) {
	let a = [''],
		l = t ? ' in' : ':';
	if (
		(n
...
function pc(e) {
	...
	for (let n of e) {
		...
		let i = `${n.selectionPath.join('.')}:${n.argumentPath.join('.')}`,
			o = t.get(i);
		o
			? t.set(i, { ...n, argument: { ...n.argument, typeNames: dc(o.argument.typeNames, n.argument.typeNames) } })
			: t.set(i, n);
	}
...
var Fe = class e extends oe {
	...
	getDeepField(t) {
		...
		for (let s of n) {
			let a;
			if (
				(o.value instanceof e ? (a = o.value.getField(s)) : o.value instanceof Ie && (a = o.value.getField(Number(s))),
				!a)
			)
				return;
			o = a;
...
function gc(e, t) {
	...
	if (o && (o.getField(n)?.markAsError(), i))
		for (let s of i.fields) s.isRelation && o.addSuggestion(new L(s.name, 'true'));
	t.addErrorMessage(s => {
...
function zi(e, t) {
	for (let r of t.fields) e.hasField(r.name) || e.addSuggestion(new L(r.name, 'true'));
}
function Oc(e, t) {
	for (let r of t.fields) r.isRelation && !e.hasField(r.name) && e.addSuggestion(new L(r.name, 'true'));
}
function Ic(e, t) {
	for (let r of t.fields) !e.hasField(r.name) && !r.isRelation && e.addSuggestion(new L(r.name, 'true'));
}
function Fc(e, t) {
	for (let r of t) e.hasField(r.name) || e.addSuggestion(new L(r.name, r.typeNames.join(' | ')));
}
function Zi(e, t) {
	let [r, n] = Me(e),
...
function Xi(e, t) {
	if (t.kind === 'object')
		for (let r of t.fields) e.hasField(r.name) || e.addSuggestion(new L(r.name, r.typeNames.join(' | ')));
}
function Me(e) {
	let t = [...e],
		r = t.pop();
...
var Yi = ': ',
	Yt = class {
		...
		write(t) {
			...
			(this.hasError && r.underline().setColor(t.context.colors.red), t.write(r).write(Yi).write(this.value));
		}
	};
var rn = class {
	arguments;
...
function ro(e) {
	...
	if (e instanceof Uint8Array)
		return Buffer.isBuffer(e) ? new R(`Buffer.alloc(${e.byteLength})`) : new R(`new Uint8Array(${e.byteLength})`);
...
function tr({ args: e, errors: t, errorFormat: r, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
	...
	let { message: l, args: c } = er(a, r),
		u = Wt({ message: l, callsite: n, originalMethod: i, showColors: r === 'pretty', callArguments: c });
...
function oo(e, t, r) {
	...
	return !t.result || !(t.result.$allModels || t.result[n])
		? e
		: Nc({ ...e, ...io(t.name, e, t.result.$allModels), ...io(t.name, e, t.result[n]) });
}
function Nc(e) {
	let t = new J(),
...
function on(e, t) {
	e === void 0 &&
		t.isPreviewFeatureOn('strictUndefinedChecks') &&
		t.throwValidationError({ kind: 'InvalidSelectionValue', selectionPath: t.getSelectionPath(), underlyingError: po });
}
var nn = class e {
	constructor(t) {
		this.params = t;
...
var ou = /^\s*at (?:((?:\[object object\])?[^\\/]+(?: \[as \S+\])?) )?\(?(.*?):(\d+)(?::(\d+))?\)?\s*$/i;
function su(e) {
	var t = ou.exec(e);
	return t
		? { file: t[2], methodName: t[1] || yt, arguments: [], lineNumber: +t[3], column: t[4] ? +t[4] : null }
...
function $e(e = {}) {
	let t = lu(e);
	return Object.entries(t).reduce((n, [i, o]) => (Eo[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o), n), {
		select: {}
	});
}
function lu(e = {}) {
...
var Co = e => (Array.isArray(e) ? e : e.split('.')),
	...
	Ro = (e, t, r) => Co(t).reduceRight((n, i, o, s) => Object.assign({}, un(e, s.slice(0, o)), { [i]: n }), r);
function mu(e, t) {
...
var yu = ['findUnique', 'findUniqueOrThrow', 'findFirst', 'findFirstOrThrow', 'create', 'update', 'upsert', 'delete'],
	hu = ['aggregate', 'count', 'groupBy'];
function dn(e, t) {
	let r = e._extensions.getAllModelExtensions(t) ?? {},
		n = [wu(e, t), bu(e, t), gt(r), M('name', () => t), M('$name', () => t), M('$parent', () => e._appliedParent)];
	return Q({}, n);
}
function wu(e, t) {
	let r = G(t),
...
function pr({ visitor: e, result: t, args: r, runtimeDataModel: n, modelName: i }) {
	...
	let o = e(t, i, r) ?? t;
	return (
		r.include && Mo({ includeOrSelect: r.include, result: o, parentModelName: i, runtimeDataModel: n, visitor: e }),
		r.select && Mo({ includeOrSelect: r.select, result: o, parentModelName: i, runtimeDataModel: n, visitor: e }),
		o
	);
}
...
function wt(e) {
	...
	if (typeof e == 'object') {
		...
		for (let r in e)
			r === '__proto__'
				? Object.defineProperty(t, r, { value: wt(e[r]), configurable: !0, enumerable: !0, writable: !0 })
				: (t[r] = wt(e[r]));
		return t;
	}
	Y(e, 'Unknown value');
...
function hn(e, t, r, n) {
	switch (r.type) {
		...
		case 'decimal':
			if (typeof e != 'number' && typeof e != 'string' && !Xo.Decimal.isDecimal(e))
...
async function mr({ query: e, tracingHelper: t, provider: r, onQuery: n, execute: i }) {
	return await t.runInChildSpan(
		{ name: 'db_query', kind: Et.CLIENT, attributes: { 'db.query.text': e.sql, 'db.system.name': _u(r) } },
		async () => {
			let o = new Date(),
				s = performance.now(),
				a = await i(),
...
function Cp(e) {
	(!we || we.length < e
		? ((we = Buffer.allocUnsafe(e * Sp)), kn.webcrypto.getRandomValues(we), (Be = 0))
...
function Mp(e, t = Zs) {
	...
	if (e > Ks) throw new be(xe.EncodeTimeSizeExceeded, `Cannot encode a time larger than ${Ks}: ${e}`);
	...
	let r,
		n = '';
	for (let i = t; i > 0; i--) ((r = e % Rt), (n = zs.charAt(r) + n), (e = (e - r) / Rt));
	return n;
}
function Dp() {
...
function Qe() {
	return (xr > br.length - 16 && ((0, Ys.randomFillSync)(br), (xr = 0)), br.slice(xr, (xr += 16)));
}
...
function Tr(e, t) {
	return e == null ? e : typeof e == 'string' ? Tr(JSON.parse(e), t) : Array.isArray(e) ? Vp(e, t) : $p(e, t);
}
function $p(e, t) {
	if (t.pagination) {
...
function Up(e, t, r) {
	...
	return (i.sort(([o], [s]) => (o < s ? -1 : o > s ? 1 : 0)), i.flatMap(([, o]) => na(o, t)));
}
		...
		case 'templateSql':
			return (e.chunkable ? Jp(e.fragments, i, n) : [i]).map(s => {
				if (n !== void 0 && s.length > n)
					throw new D('The query parameter limit supported by your database is exceeded.', 'P2029');
...
var kt = class e {
	...
	async run(t, r) {
		let { value: n } = await this.interpretNode(t, r, this.#e, this.#n.snapshot()).catch(i => qe(i));
		return n;
	}
		...
		switch (t.type) {
			...
			case 'execute': {
				let o = Hn(t.args, n, i, this.#l()),
					s = 0;
				for (let a of o)
					s += await this.#u(a, r, () => r.executeRaw(a).catch(l => (t.args.type === 'rawSql' ? yn(l) : qe(l))));
				return { value: s };
			}
			case 'query': {
				let o = Hn(t.args, n, i, this.#l()),
					s;
				for (let a of o) {
					let l = await this.#u(a, r, () => r.queryRaw(a).catch(c => (t.args.type === 'rawSql' ? yn(c) : qe(c))));
					s === void 0 ? (s = l) : (s.rows.push(...l.rows), (s.lastInsertId = l.lastInsertId));
				}
			...
			case 'dataMap': {
				...
				return { value: Yo(o, t.args.structure, t.args.enums), lastInsertId: s };
			}
			case 'validate': {
				let { value: o, lastInsertId: s } = await this.interpretNode(t.args.expr, r, n, i);
			...
			case 'mapRecord': {
				let { value: o, lastInsertId: s } = await this.interpretNode(t.args.expr, r, n, i),
					a = o === null ? {} : Pr(o);
				for (let [l, c] of Object.entries(t.args.fields)) a[l] = Yp(c, a[l], n, i);
	...
	#u(t, r, n) {
		return mr({ query: t, execute: n, provider: this.#o ?? r.provider, tracingHelper: this.#s, onQuery: this.#r });
	}
};
function ca(e) {
...
function ua(e, t) {
	return Array.isArray(e) ? e.map(r => ua(r, t)) : typeof e == 'object' && e !== null ? (e[t] ?? null) : e;
}
function Zp(e, t) {
...
var td = 100,
	...
	Ft = class {
		...
		async #r(t) {
			...
			switch (
				(i?.unref?.(),
				(r.transaction = await this.driverAdapter.startTransaction(t.isolationLevel).catch(qe)),
				clearTimeout(i),
				r.status)
			) {
				case 'waiting':
		...
		async getTransaction(t, r) {
			let n = this.#n(t.id, r);
			if ((n.status === 'closing' && (await n.closing, (n = this.#n(t.id, r))), !n.transaction)) throw new Ot();
		...
		#n(t, r) {
			...
			if (!n) {
				...
				if (i)
					switch ((It('Transaction already closed.', { transactionId: t, status: i.status }), i.status)) {
						case 'closing':
						case 'waiting':
						case 'running':
						...
						case 'rolled_back':
							throw new vr(r);
						case 'timed_out':
							throw new Cr(r, { timeout: i.timeout, timeTaken: Date.now() - i.startedAt });
					}
			...
			let n = async () => {
				...
				try {
					if (t.transaction && r === 'committed')
						if (t.transaction.options.usePhantomQuery) await this.#o(id(), t.transaction, () => t.transaction.commit());
						else {
							let i = rd();
						...
						if (t.transaction.options.usePhantomQuery)
							await this.#o(od(), t.transaction, () => t.transaction.rollback());
						else {
							let i = nd();
							try {
					...
					((t.status = r),
						...
						this.closedTransactions.length > td && this.closedTransactions.shift());
				}
			};
			t.status === 'closing'
...
function xa(e, t, r) {
	...
	if (n.expires) {
		if (!ad(n.expires) || Number.isNaN(n.expires.valueOf())) throw new TypeError('option expires is invalid');
...
var va = I('prisma:client:clientEngine:remoteExecutor'),
	_r = class {
		...
		constructor(t) {
			...
			let { url: r, apiKey: n } = Ta({ clientVersion: t.clientVersion, accelerateUrl: t.accelerateUrl });
			((this.#r = new Kn(r)),
				(this.#e = new Dr({
					apiKey: n,
		...
		#n(t) {
			...
			for (let [i, o] of this.#e) {
				...
				let s = o.domain ?? t.hostname,
					a = o.path ?? '/';
				t.hostname.endsWith(s) && t.pathname.startsWith(a) && r.push(xa(o.name, o.value));
			}
...
var Zn = require('@prisma/client-runtime-utils'),
	...
	Sa = {
		async loadQueryCompiler(e) {
			...
			if (r === void 0)
				throw new Zn.PrismaClientInitializationError('WASM query compiler was unexpectedly `undefined`', t);
			let n;
			return (
...
var Dt = class {
	...
	constructor(t, r) {
		if (t.accelerateUrl !== void 0) this.#n = { remote: !0, accelerateUrl: t.accelerateUrl };
			...
			((this.#n = { remote: !1, driverAdapterFactory: t.adapter }), Mt('Using driver adapter: %O', t.adapter));
		else
	...
	#c(t) {
		...
		try {
			...
			return new O.PrismaClientInitializationError(r.message, this.config.clientVersion, r.error_code);
		} catch {
			return t;
		}
	}
	#l(t, r) {
		...
		if (t.code === 'GenericFailure' && t.message?.startsWith('PANIC:'))
			return new O.PrismaClientRustPanicError(Ca(this, t.message, r), this.config.clientVersion);
		if (t instanceof D)
...
${n.backtrace}`,
		...
		return t instanceof O.PrismaClientRustPanicError
			...
			: typeof t.message == 'string' && typeof t.code == 'string'
				...
				: typeof t.message == 'string'
					? new O.PrismaClientUnknownRequestError(t.message, { clientVersion: this.config.clientVersion })
					: t;
	}
	#u(t, r, n = !0) {
		...
		try {
			...
			if (((global.PRISMA_WASM_PANIC_REGISTRY.set_message = i), o))
				throw (
					...
					new O.PrismaClientRustPanicError(Ca(this, o, r), this.config.clientVersion)
				);
		}
	}
	onBeforeExit() {
	...
	async requestBatch(t, { transaction: r, customDataProxyFetch: n }) {
		...
		let i = t[0].action,
			...
			l;
		try {
			l = this.#u(() => this.#m({ queries: t, execute: () => a.compileBatch(o) }));
		} catch (c) {
			throw this.#p(c);
		}
		try {
			...
			switch (l.type) {
				case 'multi': {
					...
					return (
						c !== void 0 &&
							r?.kind !== 'itx' &&
							(y ? await this.transaction('rollback', {}, c) : await this.transaction('commit', {}, c)),
						p
					);
				}
				case 'compacted': {
					if (!t.every(g => g.action === i)) throw new Error('All queries in a batch must have the same action');
...
function _a(e, t) {
	...
	if (Da.Decimal.isDecimal(e)) return { prisma__type: 'decimal', prisma__value: e.toJSON() };
	if (Buffer.isBuffer(e)) return { prisma__type: 'bytes', prisma__value: e.toString('base64') };
	if (pd(e)) return { prisma__type: 'bytes', prisma__value: Buffer.from(e).toString('base64') };
	if (ArrayBuffer.isView(e)) {
		let { buffer: r, byteOffset: n, byteLength: i } = e;
...
var dd = /^(\s*alter\s)/i,
	La = I('prisma:client');
function Xn(e, t, r, n) {
	if (!(e !== 'postgresql' && e !== 'cockroachdb') && r.length > 0 && dd.exec(t))
		...
		r => {
			...
			if (ar(r)) ((n = r.sql), (i = { values: Ge(r.values), __prismaRawParameters__: !0 }));
				...
				switch (t) {
					...
					case 'sqlserver': {
						((n = Ia(r)), (i = { values: Ge(r.values), __prismaRawParameters__: !0 }));
						break;
					}
					default:
						throw new Error(`The ${t} provider does not support ${e}`);
				}
			return (i?.values ? La(`prisma.${e}(${n}, ${i.values})`) : La(`prisma.${e}(${n})`), { query: n, parameters: i });
		},
	Va = {
...
function ei(e) {
	return function (r, n) {
		let i,
			o = (s = e) => {
				try {
					return s === void 0 || s?.kind === 'itx' ? (i ??= Ua(r(s))) : Ua(r(s));
				} catch (a) {
...
var hd = I('prisma:client:request_handler'),
	$r = class {
		...
		constructor(t, r) {
			((this.logEmitter = r),
				...
				(this.dataloader = new Nr({
					...
					batchBy: n => (n.transaction?.id ? `transaction-${n.transaction.id}` : Ha(n.protocolQuery)),
					batchOrder(n, i) {
		...
		sanitizeMessage(t) {
			return this.client._errorFormat && this.client._errorFormat !== 'pretty' ? ve(t) : t;
		}
		unpack(t, r, n) {
...
function xd(e, t) {
	return (0, Wa.hasBatchIndex)(e) && t?.kind === 'batch' && e.batchRequestIdx !== t.index;
}
function bd(e) {
...
var Za = ['errorFormat', 'adapter', 'accelerateUrl', 'log', 'transactionOptions', 'omit', '__internal'],
...
var Sd = { requestArgsToMiddlewareArgs: e => e, middlewareArgsToRequestArgs: e => e },
...
`,
		...
		_request(n) {
			...
			return this._tracingHelper.runInChildSpan(s.operation, () =>
				new al.AsyncResource('prisma-client-request').runInAsyncScope(() => a(o))
			);
		}
...
function pl() {
	let e = Ld();
	return { id: e, prettyName: $d[e] || e, isEdge: ['workerd', 'deno', 'netlify', 'edge-light'].includes(e) };
}
