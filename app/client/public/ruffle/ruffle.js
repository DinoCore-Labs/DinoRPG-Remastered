(() => {
	...
	var e,
		...
		t = {
			29: function (e, n, t) {
				...
				(Object.defineProperty(n, '__esModule', { value: !0 }), r(t(53), n), r(t(325), n), r(t(553), n), r(t(836), n));
			},
			48: (e, n) => {
			...
			56: (e, n) => {
				...
				(Object.defineProperty(n, '__esModule', { value: !0 }),
					...
					(n.applyTsxTag = function (e, n) {
						let t = e,
							a = n;
						a && 'tsxTag' in a && ((t = a.tsxTag), !a.is && e.includes('-') && (a = { ...a, is: e }));
			...
			124: (e, n, t) => {
				e.exports = t.p + '51b5a18c79da346eafe4.wasm';
			},
			125: (e, n) => {
				Object.defineProperty(n, '__esModule', { value: !0 });
			},
							...
							if ('class' === t) {
								...
								'style' === t && 'string' != typeof i
									...
									: 'dangerouslySetInnerHTML' === t
										...
										: !0 === i
											? e.setAttribute(t, t)
											: (i || 0 === i || '' === i) && e.setAttribute(t, i.toString());
						}
					}));
				const a = t(665);
				function r(e, n) {
			...
			797: (e, n, t) => {
				e.exports = t.p + 'b5f7d6e74ca0d6425d17.wasm';
			},
			836: (e, n) => {
				Object.defineProperty(n, '__esModule', { value: !0 });
			}
	...
	((r.m = t),
		...
		(r.u = e => 'core.ruffle.' + { 482: '4e2c3ac5a0fb2eca9dbd', 655: '818e4c5688ae147d262a' }[e] + '.js'),
		(r.g = (function () {
	...
	const l = {
		versionNumber: '0.2.0-nightly.2025.11.29',
		versionName: '0.2.0-nightly.2025.11.29',
		versionChannel: 'nightly',
		buildDate: '2025-11-29T00:07:42.914Z',
		commitHash: '2cbe11c08359d381a9187677544245f302a2bdf7'
	};
	var u;
	!(function (e) {
	...
	class A extends j {
		...
		constructor(e, n = {}) {
			(e instanceof A ? ((n = { ...e.opts, ...n }), (e = e.value)) : e instanceof j && (e = e.valueOf()),
	...
	function F(e, n, t) {
		return n[t] ? M(e, n[t].value) : (e.reportError(new RangeError('No default')), new S());
	}
	function q(e, n) {
		const t = [],
			a = Object.create(null);
		for (const r of n) 'narg' === r.type ? (a[r.name] = P(e, r.value)) : t.push(P(e, r));
		...
		switch (n.type) {
			...
			case 'var':
				return (function (e, { name: n }) {
					...
					switch (typeof t) {
						...
						default:
							return (e.reportError(new TypeError(`Variable type not supported: $${n}, ${typeof t}`)), new S(`$${n}`));
					}
				})(e, n);
			case 'mesg':
				return (function (e, { name: n, attr: t }) {
					const a = e.bundle._messages.get(n);
					if (!a) return (e.reportError(new ReferenceError(`Unknown message: ${n}`)), new S(n));
					if (t) {
						const r = a.attributes[t];
						return r ? M(e, r) : (e.reportError(new ReferenceError(`Unknown attribute: ${t}`)), new S(`${n}.${t}`));
					}
			...
			case 'term':
				return (function (e, { name: n, attr: t, args: a }) {
					...
					if (t) {
						...
						return (e.reportError(new ReferenceError(`Unknown attribute: ${t}`)), new S(`${r}.${t}`));
					}
					e.params = q(e, a).named;
					const i = M(e, o.value);
			...
			case 'func':
				return (function (e, { name: n, args: t }) {
					...
					if (!a) return (e.reportError(new ReferenceError(`Unknown function: ${n}()`)), new S(`${n}()`));
	...
	function D(e, n) {
		...
		for (const r of n)
			if ('string' != typeof r) {
				...
				(a && t.push('\u2068'), t.push(P(e, r).toString(e)), a && t.push('\u2069'));
	...
	function I(e, n) {
		...
		if (t instanceof C) return new C(t.valueOf(), { ...t.opts, ...$(n, T) });
		if (t instanceof A) return new C(t.toNumber(), { ...$(n, T) });
	...
	class _ {
		constructor(e, { functions: n, useIsolating: t = !0, transform: a = e => e } = {}) {
			((this._terms = new Map()),
				...
				(this._functions = { NUMBER: I, DATETIME: L, ...n }),
		...
		formatPattern(e, n = null, t = null) {
			...
			try {
				...
				if (a.errors && e instanceof Error) return (a.errors.push(e), new S().toString(a));
				throw e;
			}
		}
	}
	...
	class me {
		constructor(e) {
			...
			function l() {
				let a;
				if ((t(Q) && (a = i(Q)), '{' === e[n] || '}' === e[n])) return u(a ? [a] : [], 1 / 0);
				let r = g();
				return r ? (a ? u([a, r], r.length) : ((r.value = b(r.value, ee)), u([r], r.length))) : a ? b(a, ne) : null;
			}
			function u(a = [], r) {
				for (;;) {
					if (t(Q)) {
				...
				let l = [];
				for (let e of a) (e instanceof pe && (e = e.value.slice(0, e.value.length - r)), e && l.push(e));
				return l;
			}
			function c() {
				r(re, SyntaxError);
			...
			function m() {
				let e;
				return (r(ie, SyntaxError), (e = t(H) ? h() : { type: 'str', value: i(J) }), r(se, SyntaxError), e);
			}
			function p() {
				if (t(H)) return h();
				if ('"' === e[n])
	...
	for (const [e, n] of Object.entries(ze)) {
		...
		if (n) {
			...
			for (const [r, o] of Object.entries(n))
				if (o) {
					a ??= ke();
					for (const n of t.addResource(new me(o))) console.error(`Error in text for ${e} ${r}: ${n}`);
				}
			ye(a);
		}
		je[e] = t;
							...
							children: (0, x.jsx)('div', {
								...
								children: (0, x.jsxs)('svg', {
									...
									children: [
										...
										(0, x.jsx)('use', { xmlns: 'http://www.w3.org/2000/svg', href: '#b' })
									]
								})
							})
						}),
			...
			(0, x.jsx)(function () {
				return (0, x.jsxs)('div', {
					...
					children: [
						...
						(0, x.jsx)('div', { class: 'loadbar', children: (0, x.jsx)('div', { class: 'loadbar-inner' }) })
					]
				});
			}, {})
		),
					...
					children: (0, x.jsx)('div', {
						...
						children: (0, x.jsxs)('div', {
							...
							children: [
								...
								(0, x.jsx)('label', { id: 'volume-mute', for: 'mute-checkbox', title: Ce('volume-controls-unmute') }),
								(0, x.jsx)('label', { id: 'volume-min', for: 'mute-checkbox', title: Ce('volume-controls-mute') }),
								(0, x.jsx)('label', { id: 'volume-mid', for: 'mute-checkbox', title: Ce('volume-controls-mute') }),
								(0, x.jsx)('label', { id: 'volume-max', for: 'mute-checkbox', title: Ce('volume-controls-mute') }),
								(0, x.jsx)('input', { id: 'volume-slider', type: 'range', min: '0', max: '100', step: '1' }),
		...
		Fe.content.appendChild(
			(0, x.jsx)(function () {
				return (0, x.jsx)('div', {
					...
					children: (0, x.jsxs)('div', {
						class: 'modal-area',
						children: [(0, x.jsx)('span', { class: 'close-modal' }), (0, x.jsx)('div', { id: 'video-holder' })]
					})
				});
			}, {})
		),
			...
			(0, x.jsx)(function () {
				return (0, x.jsx)('div', {
					...
					children: (0, x.jsxs)('div', {
						...
						children: [
							(0, x.jsx)('span', { class: 'close-modal' }),
							(0, x.jsx)('span', { id: 'acceleration-text', children: Ce('enable-hardware-acceleration') }),
							(0, x.jsx)('a', {
						...
						children: [
							...
							(0, x.jsxs)('p', {
								children: [
									...
									(0, x.jsx)('span', { children: Ce('clipboard-message-copy') })
								]
							}),
							(0, x.jsxs)('p', {
								children: [
							...
							(0, x.jsxs)('p', {
								children: [
									...
									(0, x.jsx)('span', { children: Ce('clipboard-message-paste') })
								]
							})
						]
					})
	...
	try {
		if (document.currentScript instanceof HTMLScriptElement && '' !== document.currentScript.src) {
			...
			(e.endsWith('.js') || e.endsWith('/') || (e += '/'),
				($e = new URL('.', e)),
				(Te = $e.protocol.includes('extension')));
		}
	} catch (e) {
		console.warn('Unable to get currentScript URL', e);
	}
	const Ie = 'https://ruffle.rs';
	...
	const Ve = {
		OpenDemo: { type: 'open_link', url: Ie + '/demo', label: Ce('ruffle-demo') },
		DownloadDesktop: { type: 'open_link', url: Ie + '/downloads#desktop-app', label: Ce('ruffle-desktop') },
		UpdateRuffle: { type: 'open_link', url: Ie + '/downloads', label: Ce('update-ruffle') },
		...
		const r = t.join(''),
			...
			u = () => {
				(s.current.classList.add('details'),
					s.current.replaceChildren((0, x.jsx)('textarea', { readOnly: !0, children: r })));
			};
		((e.textContent = ''),
			e.appendChild(
				(0, x.jsxs)('div', {
					id: 'panic',
					children: [
						(0, x.jsx)('div', { id: 'panic-title', children: Ce('panic-title') }),
						(0, x.jsx)('div', { id: 'panic-body', ref: s, children: o }),
						(0, x.jsx)('div', {
							id: 'panic-footer',
							children: (0, x.jsx)('ul', {
								children: i.map(e =>
									(function ({ action: e, showDetails: n, errorArray: t, errorText: a, swfUrl: r }) {
										...
										if ('open_link' === e.type)
											return (0, x.jsx)('li', {
												children: (0, x.jsx)('a', { href: e.url, target: '_top', children: e.label })
											});
										{
											let e;
											...
											return (
												...
												(n += o),
												(0, x.jsx)('li', {
													children: (0, x.jsx)('a', { href: n, target: '_top', children: Ce('report-bug') })
												})
											);
										}
									})({ action: e, showDetails: u, errorText: r, errorArray: t, swfUrl: a })
								)
							})
						})
					]
	...
	async function Xe(e) {
		null === Ye &&
			(Ye = (async function (e) {
				xe();
				const n = (await Promise.all([Je(), Ge(), Ze(), Qe(), Ke()])).every(Boolean);
				(n ||
		...
		if (void 0 !== window.customElements)
			for (; a < 999; ) {
				...
				if ((a > 0 && (t = t + '-' + a), void 0 === window.customElements.get(t)))
					return (window.customElements.define(t, n), (en[e] = { class: n, name: t, internalName: e }), t);
				a += 1;
			}
	...
	function an(e, n) {
		if (
			...
			tn(n.allowNetworking) && e.setAllowNetworking(n.allowNetworking.toLowerCase()),
			tn(n.credentialAllowList) && e.setCredentialAllowList(n.credentialAllowList),
		...
		if (tn(n.gamepadButtonMapping))
			for (const [t, a] of Object.entries(n.gamepadButtonMapping)) e.addGamepadButtonMapping(t, a);
	...
	class un {
		constructor(e, n, t) {
			...
			a && (a.addEventListener('click', this.backupSaves.bind(this)), (a.innerText = Ce('save-backup-all')));
			...
			if (((e = this.checkOptions(e)), this.element.isConnected && !this.isUnusedFallbackObject())) {
				if (!pn(this.element))
					try {
						((this.loadedConfig = {
							...z,
							...(n && 'url' in e ? { allowScriptAccess: wn('samedomain', e.url) } : {}),
		...
		confirmReloadSave(e, n, t) {
			if (gn(n) && localStorage[e]) {
				...
				if (a.includes(o) && e.startsWith(r)) {
					return void (
						confirm(Ce('save-reload-prompt', { action: t ? 'replace' : 'delete' })) &&
						this.loadedConfig &&
						(this.destroy(),
		...
		populateSaves() {
			...
			((e.textContent = ''),
				Object.keys(localStorage).forEach(n => {
					...
					t && a && gn(a) && e.appendChild((0, x.jsx)(this.SaveRow, { rowKey: n, solName: t, solData: a }));
				}));
		}
		async backupSaves() {
		...
		contextMenuItems() {
			...
			return (
				...
				this.instance &&
					...
					(t(), n.push({ text: Ce('context-menu-download-swf'), onClick: this.downloadSwf.bind(this) })),
				navigator.clipboard &&
				...
				t(),
				n.push({
					text: Ce('context-menu-about-ruffle', { flavor: Te ? 'extension' : '', version: l.versionName }),
					async onClick() {
			...
			for (const e of this.contextMenuItems())
				if (null === e)
					this.contextMenuElement.appendChild(
						(0, x.jsx)('li', { class: 'menu-separator', children: (0, x.jsx)('hr', {}) })
					);
				else {
					const { text: n, onClick: t, enabled: a } = e,
						r = (0, x.jsx)('li', { class: { 'menu-item': !0, disabled: !1 === a }, 'data-text': n, children: n });
					if ((this.contextMenuElement.appendChild(r), !1 !== a)) {
						const e = async e => {
							(e.preventDefault(), e.stopPropagation(), await t(e), this.hideContextMenu());
						};
						this.contextMenuSupported
		...
		panic(e) {
			...
			if ((t.push('# Error Info\n'), e instanceof Error)) {
				if ((t.push(`Error name: ${e.name}\n`), t.push(`Error message: ${e.message}\n`), e.stack)) {
					const n = t.push(`Error stack:\n\`\`\`\n${e.stack}\n\`\`\`\n`) - 1;
					if (e.avmStack) {
						const n = t.push(`AVM2 stack:\n\`\`\`\n    ${e.avmStack.trim().replace(/\t/g, '    ')}\n\`\`\`\n`) - 1;
						t.avmStackIndex = n;
					}
					t.stackIndex = n;
				}
			} else t.push(`Error: ${e}\n`);
			(t.push(this.getPanicData()), He(this.container, n, t, this.swfUrl), this.destroy());
		}
		addOpenInNewTabMessage(e, n) {
			...
			const a = (0, x.jsxs)('div', {
				children: [
					...
					(0, x.jsx)('div', {
						children: (0, x.jsx)('a', { href: '#', onClick: () => e(t), children: Ce('open-in-new-tab') })
					})
				]
			});
		...
		displayMessageOrElement(e, n) {
			const t = e instanceof HTMLDivElement ? e : (0, x.jsx)('p', { children: e }),
				a = n
					? null
					: (0, x.jsx)('div', { children: (0, x.jsx)('button', { id: 'continue-btn', children: Ce('continue') }) }),
				r = (0, x.jsx)('div', {
					id: 'message-overlay',
		...
		displayUnsupportedVideo(e) {
			...
			if (n) {
				const t = (0, x.jsx)('video', { src: e, autoplay: !0, controls: !0, onContextMenu: e => e.stopPropagation() });
				((n.textContent = ''), n.appendChild(t), this.videoModal.classList.remove('hidden'));
			}
		}
	...
	var kn,
		...
		Rn = function (e, n, t, a) {
			if ('a' === t && !a) throw new TypeError('Private accessor was defined without a getter');
						...
						e => {
							try {
								Object.defineProperty(this, e, {
									value: (...n) => Sn(this, zn, 'f').callExternalInterface(e, n),
									configurable: !0
								});
							} catch (n) {
	...
	class Un {
		constructor(e) {
			if ((Dn.set(this, void 0), Mn.set(this, void 0), Nn(this, Dn, [], 'f'), Nn(this, Mn, {}, 'f'), e))
				for (let n = 0; n < e.length; n++) this.install(e[n]);
		}
		install(e) {
			const n = new Bn(e),
				t = _n(this, Dn, 'f').length;
			(_n(this, Dn, 'f').push(n),
				(_n(this, Mn, 'f')[e.type] = n),
				Object.defineProperty(this, n.type, { configurable: !0, enumerable: !1, value: n }),
				(this[t] = n));
		}
		item(e) {
			return _n(this, Dn, 'f')[e >>> 0];
		}
		namedItem(e) {
			return _n(this, Mn, 'f')[e];
		}
		get length() {
			return _n(this, Dn, 'f').length;
		}
		[((Dn = new WeakMap()), (Mn = new WeakMap()), Symbol.iterator)]() {
			return _n(this, Dn, 'f')[Symbol.iterator]();
		}
	...
	class Bn {
		...
		get type() {
			return _n(this, On, 'f').type;
		}
		get description() {
			return _n(this, On, 'f').description;
		}
		get suffixes() {
			return _n(this, On, 'f').suffixes;
		}
		get enabledPlugin() {
			return _n(this, On, 'f').enabledPlugin;
		}
	...
	class Vn extends Un {
		...
		get [(($n = new WeakMap()), (Tn = new WeakMap()), (In = new WeakMap()), Symbol.toStringTag)]() {
			return 'Plugin';
		}
	}
	class Hn {
		...
		item(e) {
			return _n(this, Wn, 'f')[e >>> 0];
		}
		namedItem(e) {
			return _n(this, Ln, 'f')[e];
		}
		refresh() {}
		[((Wn = new WeakMap()), (Ln = new WeakMap()), Symbol.iterator)]() {
			return _n(this, Wn, 'f')[Symbol.iterator]();
		}
		get [Symbol.toStringTag]() {
			return 'PluginArray';
		}
		get length() {
			return _n(this, Wn, 'f').length;
		}
	}
	const Jn = new Vn('Shockwave Flash', 'Shockwave Flash 32.0 r0', 'ruffle.js');
	(Jn.install({ type: Pe, description: 'Shockwave Flash', suffixes: 'spl', enabledPlugin: Jn }),
		Jn.install({ type: qe, description: 'Shockwave Flash', suffixes: 'swf', enabledPlugin: Jn }),
		Jn.install({ type: De, description: 'Shockwave Flash', suffixes: 'swf', enabledPlugin: Jn }),
		Jn.install({ type: Me, description: 'Shockwave Flash', suffixes: 'swf', enabledPlugin: Jn }));
	const Kn = window.RufflePlayer?.config ?? {},
		Zn =
			(function (e) {
				let n = $e?.href ?? '';
				return (
					!Te && 'publicPath' in e && null !== e.publicPath && void 0 !== e.publicPath && (n = e.publicPath),
					'' === n || n.endsWith('/') || (n += '/'),
					n
				);
			})(Kn) + 'ruffle.js';
	...
	function et() {
		try {
			((Qn = Qn ?? document.getElementsByTagName('object')), (Gn = Gn ?? document.getElementsByTagName('embed')));
	...
	async function tt(e, n) {
		...
		try {
			...
			return void (Te || console.warn(n + e));
		}
		if (Te || void 0 === t.documentElement.dataset.ruffleOptout)
			if (Te)
	...
	function at() {
		!(function (e) {
			...
			(('install' in navigator.plugins && navigator.plugins.install) ||
				...
				Object.defineProperty(navigator, 'plugins', { value: new Hn(navigator.plugins), writable: !1 })),
	...
	try {
		if (document.currentScript instanceof HTMLScriptElement && '' !== document.currentScript.src) {
			let e = document.currentScript.src;
			(e.endsWith('.js') || e.endsWith('/') || (e += '/'), (it = new URL('.', e)));
		}
	} catch (e) {
		console.warn('Unable to get currentScript URL', e);
	}
	!(function (e, n = {}) {
		...
		(window.RufflePlayer instanceof s
			...
			(t.sources[e] = ot),
			(ot.options = n),
			!1 !== (!('polyfills' in t.config) || t.config.polyfills) && ot.pluginPolyfill());
	})('local', {
		onFirstLoad: () => {
			r.p = (function (e) {
				let n = it?.href ?? '';
