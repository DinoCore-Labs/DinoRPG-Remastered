	...
	<footer>
		<div class="wrapper">
				...
				<div class="status">
					...
					<div class="versionId">
						<span>
							...
							<a :href="`https://github.com/DinoCore-Labs/DinoRPG-Remastered/releases/tag/${version}`" target="_blank">
								{{ version }}
							</a>
						</span>
						<span>
							...
							<a :href="`https://github.com/DinoCore-Labs/DinoRPG-Remastered/commit/${release}`" target="_blank">
								{{ release }}
							</a>
						</span>
						<span>
			...
			<div class="box small">
				<h3>Remerciements :</h3>
				<ul>
					<li v-for="helper in helpers" :key="helper">{{ helper }}</li>
				</ul>
			</div>
		</div>
	</footer>
...
.wrapper {
	...
	background-image: url('../../assets/background/sky_footer.webp');
