<!--
  ...
  Eternaltwin DinoRPG
  Upstream file: https://gitlab.com/eternaltwin/dinorpg/dinorpg/-/blob/staging/ed-ui/src/components/dojo/DojoChallenge.vue
...
<template>
	...
	<div id="dojoChallenge">
		...
		<template v-if="fightTransformed && fightStat">
			...
			<DZButton style="align-self: center" @click="nextChallenge()">{{ $t('common.back') }}</DZButton>
