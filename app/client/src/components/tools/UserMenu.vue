		...
		<div v-show="menuCalled" class="root">
			...
			<div class="shortCutMenu">
				<div class="shortCuts" @click="closeOnShortcutLinkClick">
					<RouterLink class="link" :to="`/user`" data-tutorial="account">
					...
					<RouterLink class="link" to="/faq">
						...
						<span>{{ $t('topBar.userMenu.faq') }}</span>
					</RouterLink>
					...
					<RouterLink v-if="uStore.isModerator" class="link" to="/moderation">
						<svg
							class="svgLinkIcon admin"
							focusable="false"
							aria-hidden="true"
					...
					<RouterLink class="link" to="/" @click="logOff()">
						...
						<span>{{ $t('topBar.userMenu.disconnect') }}</span>
					</RouterLink>
				</div>
			</div>
			<div class="parameters">
				...
				<div class="parameter">
					...
					<span class="param" v-html="formatContent($t('topBar.userMenu.skipFightAnimation'))"></span>
					<label class="switch">
						<input
							:checked="localStore.getSkipFightAnimation"
							class="optionCheckbox"
							type="checkbox"
							@change="onSkipFightAnimationChange"
						/>
						<span class="slider round"></span>
					</label>
				</div>
