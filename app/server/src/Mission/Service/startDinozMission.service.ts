...
import { startDinozMissionService } from '../Controller/startDinozMission.controller.js';
...
export async function startDinozMissionHandler(req: FastifyRequest<{ Params: Params }>, reply: FastifyReply) {
	try {
