...
import { stopDinozMissionService } from '../Controller/stopDinozMission.controller.js';
...
export async function stopDinozMissionHandler(req: FastifyRequest<{ Params: Params }>, reply: FastifyReply) {
	try {
