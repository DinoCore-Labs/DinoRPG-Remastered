...
export enum Boss {
	...
	TW_DESTROYER = 'TW_DESTROYER',
	TW_NIGHTMARE = 'TW_NIGHTMARE',
	TW_THUNDER = 'TW_THUNDER',
	TW_CAPTAIN = 'TW_CAPTAIN',
	TW_BIGBEASTLY_1 = 'TW_BIGBEASTLY_1',
	TW_BIGBEASTLY_2 = 'TW_BIGBEASTLY_2',
	MAGNETITE_DARK_SMASHROOM = 'MAGNETITE_DARK_SMASHROOM',
	PR_IGOR = 'PR_IGOR',
	VENERABLE = 'VENERABLE',
...
export const bossList: Readonly<Record<Boss, MonsterFiche>> = {
	...
	[Boss.TW_DESTROYER]: {
		...
		resilience: 0,
		odds: 0,
		skills: [Skill.CELERITE, Skill.VIGNES, Skill.FOCUS, Skill.TENACITE, Skill.COUP_DOUBLE],
		zones: [],
		canBeCaptured: false
	},
	[Boss.TW_NIGHTMARE]: {
	...
	[Boss.TW_THUNDER]: {
		...
		resilience: 0,
		odds: 0,
		skills: [Skill.CELERITE, Skill.COUP_DOUBLE, Skill.AGILITE, Skill.ATTAQUE_ECLAIR, Skill.FOUDRE],
		zones: [],
		canBeCaptured: false
	},
	[Boss.TW_CAPTAIN]: {
	...
	[Boss.MAGNETITE_DARK_SMASHROOM]: {
		id: Boss.MAGNETITE_DARK_SMASHROOM,
		boss: true,
		name: 'darkgp',
		level: 30,
		hp: 30,
