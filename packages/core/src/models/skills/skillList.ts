...
import { AllFighterTypeExceptBoss, FighterType } from '../fight/fighterType.js';
...
import { SkillFightConditionEnum } from './skillFightCondition.js';
...
export const skillList: Readonly<Record<Skill, SkillDetails>> = {
	...
	[Skill.HADES]: {
		...
		type: SkillType.I,
		energy: Energy.E60,
		element: [ElementType.AIR, ElementType.WATER, ElementType.WATER],
		activatable: true,
		tree: SkillTreeType.VANILLA,
